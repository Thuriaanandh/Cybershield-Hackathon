...
# ─── Post-Boot Attack Indicator Weights ──────────────────────────────────────
POST_BOOT_WEIGHTS: dict[str, int] = {
    # Credential access
    "SAM_DATABASE_ACCESSED": 40,
    "SAM_ACCESS_EVENT_LOGGED": 35,
    "LSASS_ACCESS_DETECTED": 45,
    "CREDENTIAL_TOOL_RUNNING": 40,
    "CREDENTIAL_DATABASE_COPIED": 45,
    "NEW_LOCAL_USER_CREATED": 30,
    "WINDOWS_CREDENTIALS_ENUMERATED": 25,
    "CREDENTIAL_FILE_COPIED_TO_TEMP": 35,
    "SSH_AUTHORIZED_KEYS_MODIFIED": 30,
    # Network
    "NETWORK_SCAN_TOOL_RUNNING": 25,
    "HIGH_CONNECTION_COUNT": 20,
    "MULTIPLE_UNIQUE_CONNECTIONS": 20,
    "SUSPICIOUS_PORT_CONNECTION": 30,
    "SUSPICIOUS_PORT_LISTENING": 25,
    "PACKET_CAPTURE_FILE_CREATED": 20,
    "FIREWALL_RULES_MODIFIED": 25,
    # Persistence
    "NEW_SCHEDULED_TASK_CREATED": 35,
    "SUSPICIOUS_REGISTRY_RUN_KEY": 35,
    "NEW_STARTUP_FILE_CREATED": 35,
    "SUSPICIOUS_SERVICE_INSTALLED": 30,
    "WMI_EVENT_SUBSCRIPTION_DETECTED": 35,
    "CRON_JOB_MODIFIED": 30,
    "NEW_SYSTEMD_SERVICE_CREATED": 30,
    "SHELL_PROFILE_MODIFIED": 25,
    "SUID_BINARY_CREATED_IN_TEMP": 30,
    "LD_PRELOAD_HIJACK_DETECTED": 35,
    # Filesystem
    "SENSITIVE_FILES_RECENTLY_MODIFIED": 25,
    "STARTUP_FOLDER_MODIFIED": 30,
    "ROOT_DIRECTORY_FILES_CREATED": 20,
    "ETC_PASSWD_MODIFIED": 35,
    "SHADOW_COPY_DELETION_ATTEMPTED": 45,
    "SUSPICIOUS_FILE_IN_TEMP": 20,
    "SUSPICIOUS_FILE_IN_TMP": 20,
    "AUTH_LOG_RECENTLY_MODIFIED": 25,
}

# Add post-boot weights to main indicator weights
INDICATOR_WEIGHTS.update(POST_BOOT_WEIGHTS)
PREFIX_WEIGHTS.update({
    "CREDENTIAL_TOOL_RUNNING": 40,
    "NETWORK_SCAN_TOOL_RUNNING": 25,
    "SUSPICIOUS_PORT_CONNECTION": 30,
    "SUSPICIOUS_FILE_IN_TEMP": 20,
